...
public class BatchRecord extends UpdatableRecordImpl<BatchRecord> implements Record6<UUID, BatchType, Integer, Integer, LocalDateTime, LocalDateTime> {

    private static final long serialVersionUID = -587336125;
     ...
     */
    @Override
    public Row6<UUID, BatchType, Integer, Integer, LocalDateTime, LocalDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row6<UUID, BatchType, Integer, Integer, LocalDateTime, LocalDateTime> valuesRow() {
     ...
     */
    @Override
    public BatchRecord values(UUID value1, BatchType value2, Integer value3, Integer value4, LocalDateTime value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public BatchRecord(UUID id, BatchType type, Integer remain, Integer total, LocalDateTime created, LocalDateTime modified) {
        super(Batch.BATCH);
